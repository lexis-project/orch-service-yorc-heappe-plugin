module github.com/ystia/yorc-heappe-plugin
...
require (
	...
	github.com/lexis-project/yorc-heappe-plugin v0.0.0-00010101000000-000000000000
...
replace github.com/lexis-project/yorc-heappe-plugin => ./
